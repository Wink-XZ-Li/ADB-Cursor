...
#else
#define PRODUCT_KEY "uforlynlgj5xx3zg"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//风速(可下发可上报)
//备注:
#define DPID_FAN_SPEED_ENUM 5
//温标切换(可下发可上报)
//备注:
#define DPID_TEMP_UNIT_CONVERT 19
//故障告警(只上报)
//备注:
#define DPID_FAULT 22
//当前温度_F(只上报)
//备注:
#define DPID_TEMP_CURRENT_F 23
//目标温度_F(可下发可上报)
//备注:
#define DPID_TEMP_SET_F 24
//睡眠模式开关(可下发可上报)
//备注:
#define DPID_SLEEP 25
//屏保开关(可下发可上报)
//备注:
#define DPID_SCREEN_SAVER 120
//使用时长(只上报)
//备注:每半小时更新一次
#define DPID_USAGE_TIME 150
